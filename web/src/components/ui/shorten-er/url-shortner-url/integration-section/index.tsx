    ...
    return (
        <AnimatedContainer>
            <div className="max-w-screen-xl mx-auto px-4 pt-16 md:pt-20">
                <div
                    className="p-4 md:p-8 rounded-xl w-full"
                    style={{
                ...
                >
                    ...
                    <section className="flex justify-between lg:flex-row flex-col w-full pt-10 md:w-2/3  mx-auto lg:w-full lg:mx-0 gap-y-6 lg:gap-y-0">
                        {integrationData.map((int) => (
                            <div className="text-white bg-black cursor-pointer rounded-lg p-2 md:p-4 gap-x-2 flex flex-col justify-between gap-y-4 border shadow-md border-black/10">
                                ...
                                <p className="text-white/70 w-full  sm:w-5/6 lg:w-[290px]  ">{int.text}</p>
