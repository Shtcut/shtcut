        ...
        <div className="flex items-center gap-x-[6px]">
            {edit ? (
                <div
                    ...
                    className={`text-xs cursor-pointer flex mx-auto items-center w-[105px] justify-center text-primary-0 rounded h-[34px] bg-white text-sm  font-medium border gap-x-2 border-primary-0`}
                >
