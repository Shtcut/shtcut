...
const FaceBookPreview = ({ postText, selectedImages }: PostContentProps) => {
        ...
        <Card className="shadow-sm">
            <section>
                <div className="flex items-center gap-2 border-b p-4">
                    <Image src={'/social/fb-page.png'} alt="" width={16} height={16} />
                    ...
                    <section className="flex flex-col gap-2 ">
                        ...
                        <section className="flex mt-3 gap-y-2 flex-col w-full">
                            ...
                            <section className="flex justify-between  items-center">
                                ...
                                <ReusableIcons icon={<BsChatText size={14} color="#6D6D6D" />} description="Comment" />
