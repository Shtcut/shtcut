...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@shtcut-ui/react';
...
const featureList = [
    ...
    },
    {
        ...
        description: 'Critical insights on your link views - visitor emails, time spent across pages, geo-location, ip',
    ...
    },
    {
        ...
        description: 'Customizable data room with your logo, brand identity, custom domains and social cards',
    ...
    },
    {
        ...
        description: 'Collect and manage e-signatures for all your documents (coming soon)',
    ...
    },
    {
        ...
        description: 'Invite your team members to collaborate with custom permissions (coming soon)',
                            ...
                            <AccordionItem key={key} value={key}>
                                <AccordionTrigger>
                                    <div className="flex items-center space-x-3 p-3">
                                        {icon}
                                        <h3 className="text-base font-semibold text-shade-pencil-light">{title}</h3>
                                    </div>
                                </AccordionTrigger>
                                <AccordionContent>
                                    <div className="p-3">
                                        <p className="mb-4 text-sm text-shade-pencil-light">{description}</p>
                                    </div>
