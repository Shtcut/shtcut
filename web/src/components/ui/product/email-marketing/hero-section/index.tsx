        ...
        <div>
            <section className="relative max-w-screen-custom mx-auto px-4  pt-28">
                <AnimatedContainer className="flex flex-col items-center gap-y-4">
                    <h1 className="text-4xl sm:text-[50px] sm:w-[70%] sm:leading-[60px] mx-auto text-center font-semibold">
                        Connect and drive engagement with seamless email marketing .
                    </h1>

                    <div>
                        <p className="text-[#737A8A] w-full  text-center">
                            Elevate your communication strategy with our integrated email marketing feature.
                        </p>
                        <p className="text-[#737A8A] w-full  text-center">
                ...
                <AnimatedContainer className="relative mt-8 cursor-pointer">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 gap-3 rounded-[20px] flex-col">
                        ...
                        <h2 className="text-white text-2xl font-semibold">Email Marketing</h2>
                    </div>
                </AnimatedContainer>
            </section>
        </div>
